...
public interface TaskAgent {
	...
	public ArrayNode getTasks(@Optional @Name("start") String start,
	...
	public ObjectNode createTask(@Name("taskId") ObjectNode task,
			@Optional @Name("taskListId") String taskListId) throws Exception;
	
	public ObjectNode updateTask(@Name("taskId") ObjectNode event,
			@Optional @Name("taskListId") String taskListId) throws Exception;
	
	public void deleteTask(@Name("taskId") String eventId,
			@Optional @Name("taskListId") String taskListId) throws Exception;
}
