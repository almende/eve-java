...
public interface TransportService {
	...
	/**
	 * Asynchronously Send a bytes to an other agent. String based transports
	 * may need to encode these bytes to base64. (e.g. through org.apache.commons.codec.binary.Base64)
	 * 
	 * @param senderUri
	 *            the sender url
	 * @param receiverUri
	 ...
	 */
	void sendAsync(final URI senderUri, final URI receiverUri,
			final byte[] message, final String tag) throws IOException;
